...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{CIDERCMS_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{CIDERCMS_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
cidercms_server.pl - Catalyst Testserver

=head1 SYNOPSIS

cidercms_server.pl [options]
